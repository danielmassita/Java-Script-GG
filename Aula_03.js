...
- Aprender a tocar violão (apenas com vídeo, funciona)? Na festa, violão na mão, você toca alguma coisa?
- Aprender a fazer manobras de bicicleta (apenas com vídeo, funciona)? Sair agora e pegar a bike, você faz todas as manobras?

Então, com Programação precisa COLOCAR A MÃO NA MASSA .:. Prática é a chave...

COMO APRENDER?
- assistindo aos vídeos...
- colocar a mão na massa, codar, escrever...
- ler manuais, livros, artigos...
- anotações (TUDO! que julgar importante)...
...
CRENÇAS LIMITANTES
- Tem idade mínima, máxima? NÃO. Mas pessoas são etaristas...
- Mulher pode programar? ÓBVIO, mas o setor é machista...
- Precisa morar em SP? NÃO importa, qualquer lugar...
- Preciso ser nerd? NÃO, basta querer aprender...
- Precisa matemática, inglês? NADA A VER... 
- Lógica de Programação NÃO É PERDA DE TEMPO!... 
- Programadores iniciantes possuem mais desafios, mas depois valerá a pena... 
- Não existe linguagem melhor/pior... Não seja esse cara...
- Não começa com framework, bibliotecas e afins... Começa com JavaScript PURO.
- No começo, o básico e o pequeno é um longo caminho, não algo "da noite pro dia", a prática é diária...
